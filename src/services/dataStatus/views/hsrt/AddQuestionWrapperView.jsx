...
import { Save, Trash2, ChevronDown, Plus, Search, ChevronLeft, ChevronRight, GripVertical, X, Info, Wand2 } from 'lucide-react';
import { Popup } from '@progress/kendo-react-popup';
import { DpRequestPageApi } from '../../app/hsrt/dpRequest/DpRequestPageApi';
...
const AddQuestionWrapperView = forwardRef(({ onUnsavedChange }, ref) => {
    ...
    const { getBaseVariableList, getComputedVariableList } = DpRequestPageApi();
