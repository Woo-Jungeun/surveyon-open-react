...
const BannerBlock = React.memo(({ banner, index, isLast, showN, showPct, decimalN, decimalPct, uiSettings, projectNum, overviewPayload, userId, styleCss, evaluateChartData, selectedXInfo, filterExpression, defaultBannerId }) => {
    ...
    useEffect(() => {
        const fetchChartData = async () => {
            console.log("fetchChartData diagnostic - isChartOpen:", isChartOpen, "bannerId:", banner?.id, "selectedXInfo:", selectedXInfo, "defaultBannerId:", defaultBannerId, "columns:", columns);
            ...
            console.log("fetchChartData diagnostic - stub:", stub, "bannerVarList:", bannerVarList);
