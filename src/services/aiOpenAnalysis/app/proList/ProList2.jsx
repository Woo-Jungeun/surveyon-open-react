...
const ProList2 = () => {
    ...
    const [columns, setColumns] = useState(() => [
        ...
        { field: "qnum_text", title: "문항번호", group: "VIEW", show: true, allowHide: false, order: 4, width: "60px", wrap: true },
        ...
        // ----- EDIT  → "문항통합"으로 합치기 -----
        withSubgroup("문항통합저장", 1)({ field: "qnum_text", title: "문항번호", group: "EDIT", show: true, allowHide: false, order: 1, width: "65px", wrap: true }),
        withSubgroup("문항통합저장", 2)({ field: "merge_qnum", title: "", group: "EDIT", show: true, allowHide: false, order: 2, width: "150px", wrap: false }),
