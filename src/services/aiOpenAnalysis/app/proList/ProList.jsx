...
const ProList = () => {
    ...
    const [columns, setColumns] = useState(() => [
        // ----- VIEW (Group removed) -----
        { field: "chk", title: "", show: true, allowHide: false, order: 0, width: "40px" },
        { field: "no", title: "no", show: true, allowHide: false, order: 1, width: "50px" },
        { field: "model", title: "모델", show: true, allowHide: false, order: 2, width: "60px" },
        { field: "qnum", title: "문번호", show: true, allowHide: false, order: 3, width: "100px", wrap: true },
        ...
        // ----- ADMIN -> 관리 -----
        { field: "useYN", title: "관리", group: "관리", show: true, order: 1, width: "115px" },
        { field: "exclude", title: "분석보기", group: "관리", show: true, order: 2, width: "90px" },
