...
import FieldManagementRoutes from "@/services/fieldManagement";
        ...
        <Route element={<MainLayout />}>
          ...
          {isLoggedIn ? (
            <>
              ...
              <Route path="/field_management/*" element={<FieldManagementRoutes />} />
            </>
          ) : (
            ...
            <>
              ...
              <Route path="/field_management/*" element={<Navigate to="/login" replace />} />
            </>
          )}
